...
const Maintenance = () => {
  ...
  const [stockData] = useState([
    { id: 1, aqureFit: '1', perDayCharges: '100' },
    { id: 2, aqureFit: '2', perDayCharges: '50' },
    { id: 3, aqureFit: '3', perDayCharges: '300' },
    { id: 4, aqureFit: '4', perDayCharges: '80' },
    { id: 5, aqureFit: '5', perDayCharges: '120' },
    { id: 6, aqureFit: '6', perDayCharges: '180' },
    { id: 7, aqureFit: '7', perDayCharges: '200' },
    { id: 8, aqureFit: '8', perDayCharges: '100' },
  ])
  ...
  const submitAdd = () => {
    if (formData.aqureFit) {
      const newProduct = {
        id: Date.now(), // In real app, this would be generated by backend
        aqureFit: formData.aqureFit,
        perDayCharges: formData.perDayCharges,
      }
  ...
  const handleEditProduct = (item) => {
    ...
    setFormData({
      aqureFit: item.aqureFit,
      perDayCharges: item.perDayCharges,
    })
  ...
  const filteredAndSortedData = useMemo(() => {
    let filtered = stock.filter((item) => {
      const matchesSearch = item.aqureFit.toLowerCase().includes(searchTerm.toLowerCase())
    ...
    <div className="bg-white">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  {showAddModal ? 'Add New BHK' : 'Edit BHK'}
                </h3>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Per Charges(₹) *</label>
                <input
                  type="text"
                  name="perDayCharges"
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              >
                ...
                {showAddModal ? 'Add BHK' : 'Update BHK'}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              {selectedItem && (
                <>
                  Are you sure you want to delete <strong>{selectedItem.aqureFit}</strong>? This
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">BHK Master</h2>
            <p className="text-gray-600 mt-1">Manage BHK Master</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by BHK name..."
                value={searchTerm}
          ...
          <thead>
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                <div className="flex items-center"> BHK Types</div>
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                <div className="flex items-center"> Per Charges</div>
              </th>
            ...
            {paginatedData.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <span className="text-sm font-medium text-gray-900">{item?.aqureFit} bhk</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <span className="text-sm font-medium text-gray-900">₹{item?.perDayCharges}</span>
                  </div>
                </td>

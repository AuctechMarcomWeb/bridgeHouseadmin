...
const Category = () => {
  ...
  const [stockData] = useState([
    { id: 1, categoryName: 'Apartment' },
    { id: 2, categoryName: 'Villa' },
    { id: 3, categoryName: 'House' },
    { id: 4, categoryName: 'Plot' },
  ])
  ...
  const filteredAndSortedData = useMemo(() => {
    let filtered = stock.filter((item) => {
      const matchesSearch = item.categoryName.toLowerCase().includes(searchTerm.toLowerCase())
    ...
    <div className="bg-white">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Property Master</h2>
            <p className="text-gray-600 mt-1">Manage Property Master</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by product name, details, or property..."
                value={searchTerm}

...
const [stockData] = useState([
  { id: 1, siteName: 'Green Valley Apartments' },
  { id: 2, siteName: 'Sunrise Residency' },
  { id: 3, siteName: 'Lakeview Villas' },
  { id: 4, siteName: 'Silver Heights Towers' },
  { id: 5, siteName: 'Palm City Homes' },
  { id: 6, siteName: 'Riverfront Residency' },
  { id: 7, siteName: 'Golden Gate Apartments' },
  { id: 8, siteName: 'Hilltop Residency' },
]);
    ...
    <div className="bg-white">
          ...
          <div className="bg-white p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              >
                ...
                {showAddModal ? 'Add Site' : 'Update Site'}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              {selectedItem && (
                <>
                  Are you sure you want to delete <strong>{selectedItem.siteName}</strong>? This
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Site Master</h2>
            <p className="text-gray-600 mt-1">Manage Site Master</p>
          </div>
              ...
              <tr key={item.id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-gray-900">{item?.siteName}</span>
                  </div>
                </td>

...
const ServicesModal = ({
  ...
  const handleEdit = (e) => {
    ...
    putRequest({ url: `service/${modalData?._id}`, cred: formData })
      .then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    postRequest({ url: `service`, cred: formData })
      .then((res) => {
  ...
  return (
    <Modal
      title={modalData ? `Edit Services` : `Add Services`}
      open={isModalOpen}
      footer={null}
      ...
      >
        ...
        <div className="d-flex justify-content-end gap-2">
          ...
          <button type="submit" className="btn btn-primary">
            {loading ? 'Uploading...' : 'Save Services'}
          </button>
        </div>
      </form>
    </Modal>

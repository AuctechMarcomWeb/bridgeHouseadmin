...
import BannersModal from './PropertiesModal'
...
const Properties = () => {
  ...
  // ✅ Fetch Bannerss with Pagination + Search
  useEffect(() => {
  ...
  return (
    <div className="bg-white">
      ...
      {isModalOpen && (
        <BannersModal setUpdateStatus={setUpdateStatus} setModalData={setSelectedItem} modalData={selectedItem}  isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
      )}
    </div>
  )
}

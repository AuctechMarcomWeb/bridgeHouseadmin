...
const BridgeHouseDetails = () => {
  ...
  //  Delete handler
  const confirmDelete = () => {
    deleteRequest(`bridgehouseDetails/${selectedItem?._id}`)
      .then((res) => {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Bridge House Details</h2>
          <p className="text-gray-600 mt-1">Manage Bridge House Details</p>
        </div>
...
export default BridgeHouseDetails
